...
export const api = {
    ...
    createAdminMovie: (data) => client.post('/admin/movies', data),
    updateAdminMovie: (id, data) => client.put(`/admin/movies/${id}`, data),
    deleteAdminMovie: (id) => client.delete(`/admin/movies/${id}`),
    approveMovie: (id) => client.patch(`/admin/movies/${id}/approve`),
    rejectMovie: (id) => client.delete(`/admin/movies/${id}/reject`),
    ...
    updateAdminCategory: (id, data) => client.put(`/admin/categories/${id}`, data),

    // === ADMIN HOMEPAGE BLOCKS ===
    getHomepageBlocks: () => client.get('/admin/homepage-blocks'),
    createHomepageBlock: (data) => client.post('/admin/homepage-blocks', data),
    updateHomepageBlock: (id, data) => client.put(`/admin/homepage-blocks/${id}`, data),
    ...
    updateUserRole: (id, data) => client.patch(`/admin/users/${id}/role`, data),
    updateUserStatus: (id, data) => client.patch(`/admin/users/${id}/status`, data),
    updateUserSubscription: (id, data) => client.patch(`/admin/users/${id}/subscription`, data),
    ...
    // === ADMIN OPHIM SYNC ===
    syncOphimMovies: (page) => client.post(`/admin/sync/ophim/movies`, { page }),
